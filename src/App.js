  ...
  return (
    <div className="App">
      <div className="App-header">
        ...
        <div className="bio">I am wave and this is my first smart contract.</div>
        ...
        <button className="waveButton" onClick={connectWallet}>
          Connect Metamask &nbsp;
          <img src="https://emoji.gg/assets/emoji/1385-metamask.png" width="30px" height="30px" alt="metamask" />
        </button>
